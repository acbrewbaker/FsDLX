...
//let P = Patterns.P(opcodeInfo)
//let R = Patterns.R(P)

let [<Test>] ``Comments - CommentOnly`` () =
    let itypes = Support.itypesfile
    printfn "%A" itypes
//    printfn "%A" (File.ReadAllText(itypes))
    
    printfn "%A" (Support.parseTypeFile2 itypes)
    //for i,j,k in info do printfn "%A" (i,j,k)
//    let po = ParsedOpcode.create (Support.itypesfile)
//    po |> printfn "%A"
    //po.Info |> printfn "%A"
//    OpcodeInfo().ITypes.Info |> List.iter (printfn "%A")
    //let s = ""
    //let r = R.Comments.CommentOnly
    //r.IsMatch(s) |> should equal true

//let [<Test>] ``Directives - Text`` () =
//    let s = ""
//    let r = R.Directives.Text
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Directives - Data`` () =
//    let s = ""
//    let r = R.Directives.Data
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Directives - Align`` () =
//    let s = ""
//    let r = R.Directives.Align
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Directives - Asciiz`` () =
//    let s = ""
//    let r = R.Directives.Asciiz
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Directives - Double`` () =
//    let s = ""
//    let r = R.Directives.Double
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Directives - Float`` () =
//    let s = ""
//    let r = R.Directives.Float
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Directives - Word`` () =
//    let s = ""
//    let r = R.Directives.Word
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Directives - Space`` () =
//    let s = ""
//    let r = R.Directives.Space
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Instructions - IType`` () =
//    let s = ""
//    let r = R.Instructions.IType
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Instructions - RType`` () =
//    let s = ""
//    let r = R.Instructions.RType
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Instructions - JType`` () =
//    let s = ""
//    let r = R.Instructions.JType
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Instructions - Any`` () =
//    let s = ""
//    let r = R.Instructions.Any
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Opcodes - IType`` () =
//    let s = ""
//    let r = R.Opcodes.IType
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Opcodes - RType`` () =
//    let s = ""
//    let r = R.Opcodes.RType
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Opcodes - JType`` () =
//    let s = ""
//    let r = R.Opcodes.JType
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Opcodes - Any`` () =
//    let s = ""
//    let r = R.Opcodes.Any
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Operands - IType`` () =
//    let s = ""
//    let r = R.Operands.IType
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Operands - RType`` () =
//    let s = ""
//    let r = R.Operands.RType
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Operands - JType`` () =
//    let s = ""
//    let r = R.Operands.JType
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Operands - Any`` () =
//    let s = ""
//    let r = R.Operands.Any
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Immediates - Value`` () =
//    let s = ""
//    let r = R.Immediates.Value
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Immediates - Label`` () =
//    let s = ""
//    let r = R.Immediates.Label
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Immediates - Register`` () =
//    let s = ""
//    let r = R.Immediates.Register
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Immediates - BasePlusOffset`` () =
//    let s = ""
//    let r = R.Immediates.BasePlusOffset
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Immediates - Any`` () =
//    let s = ""
//    let r = R.Immediates.Any
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Labels - New`` () =
//    let s = ""
...
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Labels - Inline`` () =
//    let s = ""
//    let r = R.Labels.Inline
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``BasePlusOffsets - ValPlusReg`` () =
//    let s = ""
//    let r = R.BasePlusOffsets.ValPlusReg
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``BasePlusOffsets - ValPlusLabel`` () =
//    let s = ""
//    let r = R.BasePlusOffsets.ValPlusLabel
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``BasePlusOffsets - RegPlusVal`` () =
//    let s = ""
//    let r = R.BasePlusOffsets.RegPlusVal
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``BasePlusOffsets - RegPlusLabel`` () =
//    let s = ""
//    let r = R.BasePlusOffsets.RegPlusLabel
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``BasePlusOffsets - Any`` () =
//    let s = ""
//    let r = R.BasePlusOffsets.Any
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Registers - R`` () =
//    let s = ""
//    let r = R.Registers.R
//    r.IsMatch(s) |> should equal true
//
//let [<Test>] ``Registers - F`` () =
//    let s = ""
//    let r = R.Registers.F
//    r.IsMatch(s) |> should equal true
